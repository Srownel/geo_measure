...
class TranslationService extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _translations = {
    ...
    'en': {
      ...
      'measure_missing_bearing' : 'Missing strike bearing or dip angle information. Make sure to first save these in the previous tabs.',
      'measure_save' : 'Save',
    ...
    'fr': {
      ...
      'measure_missing_bearing' : 'Direction de l\'horizontale ou pendage manquant. Assurez-vous d\'abord d\'enregistrer ces informations dans les onglets précédents.',
